...
public class ActorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField(myActor.currentTarget.boardPosition.ToString());
        ...
        showBoardPos = EditorGUILayout.Foldout(showBoardPos, "Board Position");
        if (showBoardPos)
        {
